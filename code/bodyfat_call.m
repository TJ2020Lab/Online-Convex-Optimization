...
function [Reg_F_ave,Reg_B_ave,Reg_TB_ave] = bodyfat_call(n,T,flag_c,data_set)
% read the data
if data_set==1
...
%     end
    ...
    Reg_TB = zeros(1,T);
    for t = 1 : T
        [Reg_F(t)] =  iclr_ltc_REAL(m,n,t,rho,...
            B_randperm(1:t,:,:),A_randperm(1:t,:),f_opt(t),...
            c,flag_c, 0,0,0,wm(:,:,1:t),R);
        [Reg_B(t)] = iclr_ltc_REAL(m,n,t,rho,...
            B_randperm(1:t,:,:),A_randperm(1:t,:),f_opt(t),...
            c,flag_c,delta(1,t),xi(1,t),1, wm(:,:,1:t),R);
        [Reg_TB(t)] = iclr_ltc_REAL(m,n,t,rho,...
            B_randperm(1:t,:,:),A_randperm(1:t,:),f_opt(t),...
            c,flag_c,delta(2,t),xi(1,t),2, wm(:,:,1:t),R);
    end
    Reg_F_ave = Reg_F_ave + Reg_F;
    Reg_B_ave = Reg_B_ave + Reg_B;
    Reg_TB_ave = Reg_TB_ave + Reg_TB;
end
